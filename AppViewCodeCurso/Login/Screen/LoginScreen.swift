...
class LoginScreen: UIView {
    ...
    lazy var logoImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "whatsapp-logo_icon-icons.com_57054 (1)")?.withRenderingMode(.alwaysTemplate)
    ...
    private func enableButton(_ enable: Bool) {
        if enable == true {
            ...
            loginButton.backgroundColor = .systemGreen.withAlphaComponent(0.4)
